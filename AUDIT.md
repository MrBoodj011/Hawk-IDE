...
Hawk's mission is to help authorized pentesters/bug-hunters/security-engineers work
...
- **L10** `src/update/selfUpdate.ts:20,55-56` — `HAWK_REPO` is interpolated into a
