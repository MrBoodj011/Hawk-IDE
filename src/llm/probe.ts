...
const PING_TOOL_NAME = '__hawk_probe_ping';
    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a tool-calling probe. Your ONLY response must be a call to the `__hawk_probe_ping` tool with value="ok". Do not produce any text. Do not call any other tool.',
      },
