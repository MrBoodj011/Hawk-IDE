...
export interface AgentOptions {
  ...
  /** Operator-authored engagement notes (from .hawk/engagement.md),
...
export class Agent {
  ...
  // startup from .hawk/engagement.md. Always injected into the system
  ...
  /** Clear learned background intelligence (the .hawk/intelligence/scenarios.jsonl files).
   ...
   *
   * Persisting to ~/.hawk/config.json is the caller's job —
  ...
  private isToolAllowed(toolName: string): { ok: boolean; reason?: string } {
    ...
    // Hawk registers tools under two names (Unix and
