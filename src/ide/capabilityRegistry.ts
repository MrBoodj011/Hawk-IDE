...
const CORE_CAPABILITIES: CapabilityDescriptor[] = [
  ...
  {
    id: 'behavior.state-machine.analyze',
    title: 'Behavioral state machine and invariant analysis',
    description:
      'Model captured workflows, invalid transitions, business invariants, accessibility activation, client-state chaos, and failure timelines.',
    category: 'validation',
    risk: 'low',
    requiredActions: ['read-workspace'],
    deterministic: true,
    ...
    estimatedCostUsd: 0,
    reliability: 0.92,
    evidenceKinds: ['behavioral-state', 'transition', 'invariant', 'timeline'],
    provenance: 'hawk-core',
    version: '1.0.0',
    enabled: true,
  },
  {
    id: 'behavior.race.plan',
    title: 'Controlled race and client-state experiment planner',
    description:
      'Create exact host, request, concurrency, and invariant budgets for authorized behavioral experiments.',
    category: 'validation',
    risk: 'high',
    requiredActions: ['read-workspace', 'run-container', 'network-access', 'active-security-test'],
    deterministic: true,
    averageDurationSeconds: 5,
    estimatedCostUsd: 0,
    reliability: 0.9,
    evidenceKinds: ['race-plan', 'approval-hash', 'invariant'],
    provenance: 'hawk-core',
    version: '1.0.0',
    enabled: true,
  },
  {
    id: 'behavior.replay.mutation',
    title: 'Deterministic replay and fix mutation testing',
    description:
      'Build sanitized replay bundles and isolated security mutation plans that validate regression tests.',
    category: 'validation',
    risk: 'medium',
    requiredActions: ['read-workspace', 'run-container'],
    deterministic: true,
    ...
    estimatedCostUsd: 0,
    reliability: 0.9,
    evidenceKinds: ['replay', 'mutation-plan', 'regression-test'],
    provenance: 'hawk-core',
    version: '1.0.0',
    enabled: true,
  },
  {
    id: 'agent.specialist.swarm',
    title: 'Behavioral security specialist swarm',
    description:
      'Plan scoped business-logic, race, authorization, frontend, API, debug, fix, and independent verification agents.',
    category: 'governance',
    risk: 'medium',
    requiredActions: ['read-workspace', 'run-container'],
    deterministic: true,
    ...
    estimatedCostUsd: 0,
    reliability: 0.94,
    evidenceKinds: ['agent-plan', 'dependency-dag', 'verification-gates'],
    provenance: 'hawk-core',
    version: '1.0.0',
    enabled: true,
  },
